...
{
public:
    Tree( int size, const T& emptyValue = T(0));//T emptyValue = 0;
    Tree( const Tree<T,AS>& o );
    ~Tree();
    ...
    void swap( Tree<T,AS>& o );
    Tree<T,AS>& operator= ( Tree<T,AS> o );
...
protected:
    ...
    public:
        ...
        friend void Tree<T,AS>::deleteNode( Node** node );
